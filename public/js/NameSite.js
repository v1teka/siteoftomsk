...
// Действие при наведении на пункт основго меню
	$("li.MenuListExitToALL").hover(
		function() { ElementBackground = $(this).css("backgroundColor");
					 ElementColor = $(this).css("color");
					 $(this).css({"width": $("ul.MenuList").width() + "px", "marginRight": "0px", "background": "DimGray", "color": "white", "padding": "6px 0 6px 20px"});},
		function() { $(this).css({"backgroundColor": ElementBackground, "color": ElementColor, "padding": "0 0 0 0"});
...
// функция идентификации выбраннй ссылки BigMenu
function OpenElementMenuList (ElementMenuList) {
 // действия по переходу на новую станицу
 	
 	
// 	location.href=ArrayMenuList[ElementMenuList][1];
}
